...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"DETAIL_PROPERTY_CODE" => array(
			...
			5 => "MATERIAL",
			6 => "TIP_TOVARA",
			7 => "GIDRAVLICHESKOE_SECHENIE",
			8 => "KLASS_NAGRUZKI",
			9 => "KOMPLEKT",
			10 => "TSVET",
			11 => "KOL_VO_SHTUK_V_PALLETE",
			12 => "OBEM_PALLETA",
			13 => "VES_BUKHTY_KG",
			14 => "VYSOTA_BUKHTY",
			15 => "KOL_VO_V_BUKHTE_P_M_",
			16 => "OBEM_BUKHTY",
			17 => "TIP_TRUBY",
			18 => "DIAMETR",
			19 => "KOLTSEVAYA_ZHESTKOST",
			20 => "FILTRATSIYA",
			21 => "VNESHNIY_DIAMETR_BUKHTY",
			22 => "VYSOTA_KOLODTSA",
			23 => "VNESHNIY_DIAMETR",
			24 => "PLOSHCHAD_V_UPAKOVKE",
			25 => "GARANTIYA",
			26 => "GABARITY",
			27 => "GABARITNYE_RAZMERY_KORPUSA",
			28 => "RAZMER_KRYSHKI",
			29 => "NADPIS",
			30 => "OBEM_BETONA",
			31 => "KOL_VO_V_UPAKOVKE",
			32 => "TOLSHCHINA_STENKI",
			33 => "RAZMER_MM",
			34 => "DIAMETR_PODKLYUCHENIYA",
			35 => "PROIZVODITELNOST",
			36 => "KOL_VO_POLZOVATELEY",
			37 => "GLUBINA_MONTAZHA",
			38 => "ZALPOVYY_SBROS",
			39 => "MOSHCHNOST_USTANAVLIVAEMYKH_NASOSOV",
			40 => "SPOSOB_VODOOTVEDENIYA",
			41 => "NOMINALNOE_DAVLENIE_PN",
			42 => "MATERIAL_KORPUSA",
			43 => "MATERIAL_KRYSHKI",
			44 => "MATERIAL_SHPINDELYA",
			45 => "MATERIAL_KLINA",
			46 => "MATERIAL_UPLOTNENIYA",
			47 => "MATERIAL_KLAPANA",
			48 => "MATERIAL_SHIBERA",
			49 => "MATERIAL_OPORNOGO_BLOKA",
			50 => "MATERIAL_VALA",
			51 => "MATERIAL_DISKA",
			52 => "GLUBINA_ZALOZHENIYA_TRUBY",
			53 => "DIAMETR_TRUBY",
			54 => "RAZMER_YACHEYKI",
			55 => "NESUSHCHAYA_POLOSA",
			56 => "CHASTOTA",
			57 => "KOLICHESTVO_FAZ",
			58 => "DVIGATEL",
			59 => "SINKHRONNYY_GENERATOR",
			60 => "MOSHCHNOST",
			61 => "NAPRYAZHENIE",
			62 => "ISPOLNENIE",
			63 => "AVTOZAPUSK",
			64 => "RASKHOD_TOPLIVA_PRI_100_NAGRUZKE",
			65 => "TOPLIVNYY_BAK",
			66 => "KONTROLLER",
			67 => "OBEM",
			68 => "SREDNIY_RASKHOD_NA_M2",
			69 => "TEPLOSTOYKOST_V_TECH_3_CH_NE_MENEE",
			70 => "TEMPERATURA_PRIMENENIYA",
			71 => "PROCHNOST_STSEPLENIYA_S_BETONOM",
			72 => "VREMYA_VYSYKHANIE_PRI_TEMPERATURE_NE_NIZHE_20_C",
			73 => "DLINA_RULONA",
			74 => "OBEM_RULONA",
			75 => "RAZRYVNAYA_SILA_NE_MENEE",
			76 => "PROP_2090",
			77 => "PROP_2027",
			78 => "PROP_2098",
			79 => "PROP_2112",
