							...
							<div class="item-buttons item_<?=$arItem["ID"]?>">
								<div class="small-block counter_wrapp list clearfix n-mb">
									...
									<div class="button_block <?=(in_array($arItem["ID"], $arParams["BASKET_ITEMS"]) || $arAddToBasketData["ACTION"] == "ORDER"|| $arAddToBasketData["ACTION"] == "SUBSCRIBE" || ($arAddToBasketData["ACTION"] == 'MORE' || !$arAddToBasketData["CAN_BUY"]) || !$arAddToBasketData["OPTIONS"]["USE_PRODUCT_QUANTITY_LIST"] ? "wide" : "");?>">
										<!--noindex-->
										<?if($arAddToBasketData['TEXT'][0] == 'Подробнее'):?>
											<div class="btn btn-default btn--fast-view-click">
												<i class="svg inline  svg-inline-fw ncolor colored" aria-hidden="true" title="Выбрать">
													<svg xmlns="http://www.w3.org/2000/svg" width="18" height="12" viewBox="0 0 18 12">
														<defs>
															<style>.cls-1{fill:#999;fill-rule:evenodd;}</style>
														</defs>
														<path data-name="Rounded Rectangle 1053 copy 5" class="cls-1" d="M517.706,4560.71l-4.991,5a1,1,0,1,1-1.421-1.42l3.288-3.29H501a1,1,0,0,1,0-2h13.582l-3.288-3.29a1,1,0,1,1,1.421-1.42l4.991,5A1,1,0,0,1,517.706,4560.71Z" transform="translate(-500 -4554)"></path>
													</svg>
												</i>
												<span>Выбрать</span>
											</div>
